...
Wir wollten die Funktion programmieren, dass der Player automatisch zum Startpunkt "geworfen" wird, wenn er die Wände des Laybirinths berührt. Da unser Labyrinth nicht zentriert war und die Funktion nur mit den Eingaben der Koordinaten nicht gekklappt hat, haben wir uns dazu entschieden, das Labyrinth neu zu erstellen und dabei den Spiel-Startpunkt in die Mitte des Feldes zu setzen. Dies hat die meiste Zeit der Doppelstunde beansprucht. Anschließend haben wir die gewünschte Funktion installieren können. 
